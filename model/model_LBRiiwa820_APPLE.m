...
% ----------------------------------------
SP.J(1).t    = [  0.1+0.1575*sqrt(2)/2 -0.25-0.1575*sqrt(2)/2    0.45 ]';
SP.J(1).f    = [  0.0     0.0      0.0 ]';
SP.J(1).rpy  = [ pi/2     pi/4    -pi/2 ]';
SP.J(1).type = 'R';

SP.J(2).t    = [  0.0    0.0    0.2025 ]';
SP.J(2).f    = [  0.0    0.0    0.0 ]';
SP.J(2).rpy  = [  pi/2    0.0   0 ]';
SP.J(2).type = 'R';

SP.J(3).t    = [  0.0     0.21     0.0 ]';
SP.J(3).f    = [  0.0     0.0      0.0 ]';
SP.J(3).rpy  = [  -pi/2     0.0     0 ]';
SP.J(3).type = 'R';

SP.J(4).t    = [  0.0    0.0       0.21 ]';
...
SP.J(5).rpy  = [  -pi/2   0     0.0 ]';
SP.J(5).type = 'R';

SP.J(6).t    = [  0.0     0.0      0.2 ]';
SP.J(6).f    = [  0.0     0.0      0.0 ]';
SP.J(6).rpy  = [  pi/2    0      0.0 ]';
SP.J(6).type = 'R';

SP.J(7).t    = [  0.0     0.126      0.0 ]';
